...
export default function Header() {
  ...
  return (
    <div className="relative">
      <div className="absolute top-[30vh] w-full flex justify-center">
        <div>
      ...
      <div className="w-full bg-youtube-darkbg text-white flex flex-row py-2 justify-between items-center px-2">
        <div className="flex flex-row">
          ...
          <div className="flex flex-row justify-start items-center ml-2">
            <svg className="h-8" viewBox="0 0 37 20" focusable="false">
              <svg
                viewBox="5 0 20 20"
            ...
            <div className="font-bold tracking-[-0.1rem] h-full text-lg">
              YouTube
            </div>
          </div>
        </div>
        ...
        <div className="mr-2 translate-y-1">
          <button type="button" onClick={openModal}>
            <svg
              ...
              viewBox="0 0 24 24"
              strokeWidth={1.5}
              className="w-10 h-10 stroke-black bg-white p-2 rounded-full"
            >
              <path
                strokeLinecap="round"
